...
async def main():
    prompts = [
        {"prompt": "写一个java版本的文件上传代码", "max_tokens": 1500, "temperature": 0.7, "stream": True},
        {"prompt": "解释量子计算的基本原理", "max_tokens": 1500, "temperature": 0.6, "stream": True},
        {"prompt": "用Python实现快速排序算法", "max_tokens": 1500, "temperature": 0.5, "stream": True},
        {"prompt": "写一篇关于人工智能伦理的短文", "max_tokens": 1500, "temperature": 0.8, "stream": True},
        ...
        {"prompt": "怎么能上大学", "max_tokens": 1500, "temperature": 0.7, "stream": True},
        {"prompt": "自己写一个vue框架", "max_tokens": 1500, "temperature": 0.7, "stream": True},
    ]
